...
write.csv(abund_oct_sel %>% mutate(number_sel_thou = number_sel/1000) %>% rename(biomass_sel_ton = biomass_sel), "tableA4-5&6.csv", fileEncoding = "CP932", row.names=F)
write.csv(est %>% mutate(number = number/1000) %>% rename(number_thou = number, biomass_ton = biomass), "tableA4-7&8.csv", fileEncoding = "CP932", row.names=F) 
write.csv(biomass_female %>% mutate(biomass_ton = biomass/1000000) %>% rename(year = year2), "tableA4-8female.csv", fileEncoding = "CP932", row.names=F)
