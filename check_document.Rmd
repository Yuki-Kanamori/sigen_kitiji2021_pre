...
write.csv(catch_new, "catch2020.csv", fileEncoding = "CP932") #来年の資源評価で使うデータ
...
write.csv(length, "tableA4-2.csv", fileEncoding = "CP932")
...
write.csv(est, "tableA4-7&8.csv", fileEncoding = "CP932", row.names=F) 
write.csv(biomass_female, "tableA4-8female.csv", fileEncoding = "CP932")
write.csv(fishing_trend, "tableA4-9.csv", fileEncoding = "CP932")
